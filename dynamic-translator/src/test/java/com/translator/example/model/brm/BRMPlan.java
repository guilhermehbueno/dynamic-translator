...
public class BRMPlan{
	...
	private BRMCanaisVenda canais_venda;
	private String cidade;
	private String estado;
	private BRMPaymentMethod metodo_pagamento;
	private String regiao_anatel;
	private List<BRMDeal> deals;
	...
	public BRMCanaisVenda getCanais_venda() {
		return canais_venda;
	}
	public void setCanais_venda(BRMCanaisVenda canais_venda) {
	...
	public BRMPaymentMethod getMetodo_pagamento() {
		return metodo_pagamento;
	}
	public void setMetodo_pagamento(BRMPaymentMethod metodo_pagamento) {
	...
	public List<BRMDeal> getDeals() {
		return deals;
	}
	public void setDeals(List<BRMDeal> deals) {
		this.deals = deals;
	}
}
