...
@Translator(from=BRMProduct.class, to=SGAProduct.class, environment="SIMULADOR", description="Tradutor de campos complexos de produto")
public class ComplexProductTranslator extends DynamicTranslator{
